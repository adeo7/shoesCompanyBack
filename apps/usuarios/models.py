...
class Usuario(AbstractBaseUser, PermissionsMixin, BaseModel):
    ...
    telefono = models.CharField('Telefono usuario', max_length=15, blank=False, null=False, default='')
...
class LocalUsuario(BaseModel):
    ...
    telefono_local = models.CharField('Telefono local', max_length=15, blank=False, null=False)
